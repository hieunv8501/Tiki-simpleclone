var container = {
  ...
  showInput: function () {
    ...
    var nameProduct = document.querySelectorAll (
      '.history-header-search-item'
    )[0];

    var closeProductTwo = document.querySelectorAll (
      '.close-history-product'
    )[1];

    var nameProductTwo = document.querySelectorAll (
      '.history-header-search-item'
    )[1];

    var closeProductThree = document.querySelectorAll (
      '.close-history-product'
    )[2];

    var nameProductThree = document.querySelectorAll (
      '.history-header-search-item'
    )[2];
  ...
  showHistoryBtn: function () {
    ...
    var clickOffInput = document.querySelector (
      '.close-the-search-panel-title'
    );
  ...
  bannerSlider: function () {
    var bannerSize = document.querySelector ('.trademark-slider-app')
      .clientWidth;
  ...
  tabIndex: function () {
    ...
    var productSuggestions = document.querySelectorAll (
    ...
    var result = boxTab.forEach (function (tab, index) {
      ...
      tab.onclick = function () {
        document
          .querySelector ('.sticky-list-tab.sticky-active')
          .classList.remove ('sticky-active');
        document
          .querySelector ('.product-suggestions-container.block-active')
          .classList.remove ('block-active');
    ...
    var suggestionsMainTwo = document.querySelector (
      '.suggestions-main-js-two'
    );
    var suggestionsMainThree = document.querySelector (
      '.suggestions-main-js-three'
    );
    var suggestionsMainDeal = document.querySelector (
      '.suggestions-main-js-deal'
    );
    var suggestionsMainCheap = document.querySelector (
      '.suggestions-main-js-cheap'
    );
    var suggestionsMainSale = document.querySelector (
      '.suggestions-main-js-sale'
    );
    var suggestionsMainNew = document.querySelector (
      '.suggestions-main-js-new'
    );
    var suggestionsMainTrend = document.querySelector (
      '.suggestions-main-js-trend'
    );
  ...
  inputMonile: function () {
    ...
    var closeHistoryThree = document.querySelectorAll (
      '.close-mobile-search'
    )[2];
    ...
    var itemHistoryThree = document.querySelectorAll (
      '.history-mobile-item'
    )[2];
